-- =========================================================
-- Dan Decor — AI Agent database setup
-- Run this once in phpMyAdmin against the `dan_decor` database.
-- Only ADDS new tables — nothing existing is touched or deleted.
-- =========================================================
